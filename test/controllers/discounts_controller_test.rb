...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { amount: @discount.amount, restaurant_id: @discount.restaurant_id, start_time: @discount.start_time }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { amount: @discount.amount, restaurant_id: @discount.restaurant_id, start_time: @discount.start_time }
    assert_redirected_to discount_path(assigns(:discount))
  end
